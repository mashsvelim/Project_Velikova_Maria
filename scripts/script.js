...
const courses = [
  {
    ...
    fullDescription: `
      ...
      <ul>
        ...
        <li>Сохранение стиля оригинала</li>
      </ul>
  ...
  },
  {
    ...
    fullDescription: `
      ...
      <p>💡 Результат: готов к международным экзаменам и работе на иностранном языке</p>
    `
  },
  {
  ...
  },
  {
    ...
    fullDescription: `
      ...
      <p>⚙️ Формат обучения:
        Живые занятия, практические задания, тестирование
      </p>
